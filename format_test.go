...
func TestFormatErrorf(t *testing.T) {
	tests := []struct {
		...
		"error\n" +
			...
			"\t.+/github.com/pkg/errors/format_test.go:52",
	}}
...
func TestFormatWrap(t *testing.T) {
	tests := []struct {
		...
		"error\n" +
			...
			"\t.+/github.com/pkg/errors/format_test.go:78",
	}, {
		Wrap(io.EOF, "error"),
		"%s",
		"error: EOF",
		...
		"EOF\n" +
			"error\n" +
			"github.com/pkg/errors.TestFormatWrap\n" +
			"\t.+/github.com/pkg/errors/format_test.go:92",
	}, {
		...
		"EOF\n" +
			"error1\n" +
			"github.com/pkg/errors.TestFormatWrap\n" +
			"\t.+/github.com/pkg/errors/format_test.go:99\n",
	}, {
...
func TestFormatWrapf(t *testing.T) {
	tests := []struct {
		...
		"EOF\n" +
			...
			"\t.+/github.com/pkg/errors/format_test.go:130",
	}, {
		...
		"error\n" +
			"github.com/pkg/errors.TestFormatWrapf\n" +
			"\t.+/github.com/pkg/errors/format_test.go:145",
	}}
